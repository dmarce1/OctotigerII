/** @file
 * @brief Fixed-size vector arithmetic with argument-dependent math lookup.
 * @ingroup math
 */
#pragma once
...
/// Fixed-size arithmetic vector. Math calls use argument-dependent lookup
/// so element types may supply their own overloads.
/// @ingroup math
